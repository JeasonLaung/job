...
<div class="edit-prediv" :class=" [options.pageType == 'mine' ? 'mine-edit-prediv' : '']">
  ...
  <div class="base-info section">
    <div class="avatar-box">
      <!-- <open-data type="userAvatarUrl" class="avatar-img"></open-data>  -->
       <img class="avatar-img" v-if="resume.avatar" :src="resume.avatar" ></img> 
       <img class="avatar-img" v-else src="/static/images/default_avatar2.png" ></img> 
    </div>
    <div class="info-box">
      <div class="" v-if="resume.name">
        <div class="name-sex">
          <span class="name font-36">{{resume.name}}</span>
          <i style="display:inline" class="icon-sexm iconfont" v-if="resume.sex == 1" />
        ...
        <div class="email">
          ...
          <span class="font-gray-26">{{resume.user_email}}</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <!-- 个人链接 -->
  <div class="self-link section" v-if="resume.link">
     <div class="hd">
